...
import { getSavedAssets, type SavedLibraryAsset } from "@/lib/supabase";
...
export function AppSidebar() {
  ...
  const [history, setHistory] = useState<SavedLibraryAsset[]>([]);
      ...
      <Sidebar className="border-r border-border-subtle bg-surface-1">
        ...
        <SidebarContent>
          <SidebarGroup className="px-3">
            <SidebarGroupLabel className="text-fg-muted font-semibold text-xs tracking-wider uppercase mb-2">
              Campanhas Recentes
            </SidebarGroupLabel>
            <SidebarGroupContent>
              ...
              <SidebarMenuItem>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <SidebarMenuButton
                      size="lg"
                      className="w-full justify-between bg-surface-2 hover:bg-surface-3 border border-border-subtle rounded-xl transition-all"
                    >
                      <div className="flex items-center gap-3 truncate">
                        ...
                        <div className="flex flex-col items-start truncate">
                          <span className="text-sm font-semibold text-fg-primary truncate max-w-[120px]">
                            {user.email}
                          </span>
                  ...
                  <DropdownMenuContent
                    side="right"
                    align="end"
                    className="w-56 bg-surface-2 border-border-strong text-fg-primary shadow-2xl rounded-xl p-1.5"
                  >
                    <DropdownMenuItem
                      className="cursor-pointer hover:bg-surface-3 rounded-lg py-2.5 font-medium"
                    ...
                    <DropdownMenuItem
                      className="cursor-pointer hover:bg-rose-500/10 hover:text-rose-400 rounded-lg py-2.5 font-medium mt-1"
