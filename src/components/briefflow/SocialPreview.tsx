...
export function SocialPreview({
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file) return;
    const toastId = toast.loading("Enviando imagem com segurança...");
    ...
    try {
      ...
      const signedUrl = await uploadCampaignAsset(file, "social");
      ...
      onChange({
        ...
        themeColor: visionResult.primaryBrandColor ?? state.themeColor,
        secondaryColor:
          visionResult.secondaryBrandColor ?? state.secondaryColor,
      });
      toast.success("Imagem protegida e paleta harmonizada!", { id: toastId });
    } catch (error) {
      toast.error(
  ...
  return (
    <div
      className={cn(
        ...
        !isExportClone && "max-w-[420px] space-y-4",
        exportWrapperClass,
        fontClass,
      )}
      data-testid="social-preview"
      style={{ fontFamily: baseFontFamily, ...exportWrapperStyle }}
    >
      <div
        className={cn(
          "overflow-hidden flex flex-col",
          !isExportClone && "rounded-[24px] border shadow-xl",
        )}
        style={{ backgroundColor: boxColor, borderColor: `${textColor}20` }}
      >
        {/* HEADER DO POST */}
        {!isExportClone && (
          <div
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col justify-center">
                <div className="flex items-center gap-1.5">
                  ...
                  ></div>
                  <span
                    className="text-[12px] font-bold cursor-pointer transition-opacity hover:opacity-80"
        ...
        {/* ÁREA DA ARTE VISUAL */}
        <div
          id="social-export-node"
          data-export-node="social"
          className={cn(
            "relative aspect-[4/5] w-full overflow-hidden flex items-center justify-center group/hero-img",
            !isExportClone && "border-y",
          )}
          style={{ backgroundColor: boxColor, borderColor: `${textColor}10` }}
        >
          {hasOffer && (
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${themeColor}ee, ${secondaryColor}dd)`,
                color: textColor,
          ...
          {!activeHeroUrl && draggableImages.length === 0 ? (
            ...
            <>
              ...
              {!hasImportedImage && imageStatus !== "error" && url && (
                <>
                  <div
                    className="absolute inset-0 z-0 blur-3xl transition-colors duration-500"
              ...
              {hasImportedImage && (
                <div className="absolute inset-0 z-[1] flex items-center justify-center">
                  <img
                    ...
                    crossOrigin={
                      state.productImageUrl?.startsWith("data:") ||
                      state.productImageUrl?.startsWith("blob:")
                        ? undefined
                        : "anonymous"
                    }
                    alt="Post Importado"
            ...
            <div className="flex items-center justify-between px-3 py-2">
              <div className="flex items-center gap-1">
                ...
                >
                  <Heart
                    ...
                    style={{ color: !liked ? textColor : undefined }}
              ...
              >
                <Bookmark
                  ...
                  style={{
                    color: textColor,
                    fill: saved ? textColor : "transparent",
                  }}
                />
              </button>
            </div>
          ...
          <div className="editor-toolbar-actions shrink-0">
            <Popover>
              ...
              <PopoverContent
                side="top"
                align="end"
                className="mb-2 w-[min(320px,calc(100vw-24px))] rounded-2xl border-border-strong bg-surface-1 p-4 shadow-[var(--shadow-elevated)] z-50"
              >
            ...
            <Button
              size="sm"
              variant="outline"
              className="h-8 text-xs font-bold rounded-lg border-border-strong"
              onClick={() => fileRef.current?.click()}
            >
            ...
            <Button
              size="sm"
              variant="ghost"
              className="h-8 text-xs font-bold rounded-lg bg-surface-2 hover:bg-surface-3"
