...
export function EmailPreview({
  ...
  const renderImageWindow = (
    ...
    return (
      <div
        className={cn(
          "relative w-full flex flex-col items-center justify-center transition-colors pointer-events-auto overflow-hidden",
          classes,
          safeBgUrl
            ? "border-transparent"
        ...
        style={{
          ...extraStyles,
          borderColor: safeBgUrl
            ? "transparent"
            : extraStyles?.borderColor || `${themeColor}40`,
          backgroundColor: safeBgUrl ? "transparent" : `${themeColor}10`,
        }}
        ...
        {testimonials.map((test, i) => {
          ...
          return (
            <div
              ...
              style={{
                backgroundColor: forceInvertedStyle
                  ? themeColor + "E6"
                  : boxColor + "E6",
                borderColor: borderC,
              }}
  ...
  const textCardShapeClass =
    backgroundShape === "arch"
      ? "rounded-t-[80px] rounded-b-3xl"
      : backgroundShape === "pill"
        ? "rounded-[100px] px-8"
        : backgroundShape === "blob"
          ? "rounded-[30%_70%_70%_30%/30%_30%_70%_70%]"
          : backgroundShape === "curve"
            ? "rounded-3xl rounded-tr-[100px]"
            : "rounded-3xl";

  const textCardClass = cn(
    "p-12 shadow-2xl relative z-10 w-full pointer-events-auto transition-all",
    textCardShapeClass,
  );
  const textCardStyle = {
  ...
  if (layoutStyle === "editorial") {
    emailContent = (
      ...
      >
        ...
        <div
          className="flex-1 rounded-[24px] shadow-2xl p-10 flex flex-col justify-center"
          style={{ backgroundColor: boxColor + "F2", color: textColor }}
        >
          <div
            className="py-6 border-b text-center mb-10"
          ...
          <Editable
            ...
            className="font-serif text-[42px] leading-tight mb-6 text-center"
            style={{ color: textColor }}
          />
          ...
          {hasOffer && (
            <div
              className="mt-8 font-bold text-lg mb-8 py-5 px-6 rounded-xl border text-center shadow-sm mx-6"
              style={{
                color: themeColor,
          ...
          {cta && (
            <div className="mt-8 flex justify-center">
              <button
                className="px-10 py-4 font-bold text-[15px] text-white shadow-xl hover:scale-105 active:scale-95 transition-transform"
          ...
          <div className="px-6">
            {renderTestimonials(
              "border-t border-b py-4 my-8",
              "font-bold text-[15px]",
              "text-[14px] italic mt-1",
            )}
            {footerInfo && (
              <Editable
                as="p"
                ...
                className="mt-10 text-xs opacity-50 text-center"
                style={{ color: textColor }}
              />
            )}
          </div>
    ...
    emailContent = (
      ...
      >
        <div
          className="px-8 py-6 flex items-center justify-between border-b relative z-10 shadow-sm"
          style={{
        ...
        <div
          className={cn(
            textCardClass,
            "rounded-b-none rounded-t-[40px] flex-1 -mt-8",
          )}
          style={textCardStyle}
        >
          {heroBadge && (
            <div
              className="inline-block px-3 py-1 mb-5 text-[10px] font-bold uppercase tracking-widest border rounded-md"
          ...
          <Editable
            ...
            value={title}
            onChange={(v) => onChange({ subtitle: v })}
            className="font-extrabold text-[32px] mb-6 leading-[1.1]"
            style={{ color: textColor }}
          />
          ...
          {hasOffer && (
            <div
              className="font-bold text-lg mb-8 py-5 px-6 rounded-xl border text-center shadow-sm mt-8"
              style={{
                color: themeColor,
                backgroundColor: `${themeColor}10`,
                borderColor: `${themeColor}33`,
          ...
          {cta && (
            <button
              className="mt-4 px-8 py-4 rounded-md font-bold text-sm text-white shadow-md hover:bg-opacity-90 transition-colors w-full active:scale-[0.98]"
          ...
          {renderTestimonials(
            "p-5 bg-black/5 rounded-lg my-8 border-l-4",
            "font-bold text-[15px]",
            "text-[14px] italic mt-1",
          )}
          ...
          {footerInfo && (
            <Editable
              ...
              value={footerInfo}
              onChange={(v) => onChange({ footerInfo: v })}
              className="mt-8 text-xs text-center opacity-50"
              style={{ color: textColor }}
            />
          )}
        </div>
    ...
    emailContent = (
      ...
      >
        <div
          className={cn(
            textCardClass,
            "w-full rounded-none min-h-[400px] flex flex-col justify-center border-0",
          )}
          style={textCardStyle}
        >
          <Editable
            ...
            value={brandName}
            onChange={(v) => onChange({ brandName: v })}
            className="font-bold tracking-widest text-xs mb-8 uppercase opacity-80"
          />

          {heroBadge && (
            <div
              className="inline-block px-4 py-1.5 rounded-full mb-5 text-[10px] font-bold uppercase tracking-widest border w-max"
          ...
          <Editable
            ...
            value={title}
            onChange={(v) => onChange({ subtitle: v })}
            className="font-extrabold tracking-tight text-[34px] mb-6 leading-[1.1]"
            style={{ color: textColor }}
          />
          ...
          {hasOffer && (
            <div
              className="font-bold text-lg py-5 px-6 rounded-xl border text-center shadow-lg w-full mb-6"
              style={{
                color: themeColor,
          ...
          {cta && (
            <button
              className="px-8 py-4 rounded-xl font-bold text-[14px] shadow-2xl hover:scale-105 active:scale-95 transition-transform w-full"
              style={{ color: boxColor, backgroundColor: themeColor }}
            >
              <Editable
                as="span"
                value={cta}
        ...
        <div className="flex-1 p-8 flex flex-col items-center justify-start">
          {renderImageWindow(
            "w-full aspect-[4/5] shadow-2xl rounded-[16px] mb-8",
          )}
          {renderTestimonials(
            "p-5 border rounded-xl my-6 w-full",
            "font-bold text-[14px] mb-1",
            "text-[13px] italic",
          )}
        </div>
      </div>
    ...
    emailContent = (
      ...
      >
        <div
          className="p-16 pb-40 relative text-center rounded-b-[60px] shadow-xl"
          style={{ backgroundColor: `${themeColor}E6`, color: boxColor }}
        >
          <Editable
            as="h1"
            value={brandName}
            onChange={(v) => onChange({ brandName: v })}
            className="font-bold tracking-widest text-sm mb-6 uppercase opacity-80"
          />
          <Editable
            as="h2"
            value={title}
            onChange={(v) => onChange({ subtitle: v })}
            className="font-black tracking-tight text-[46px] mb-6 leading-[1.1] drop-shadow-md"
            style={{ color: boxColor }}
          />
          {heroBadge && (
            <div className="inline-block px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest bg-white/20 text-white">
              <Editable
                as="span"
                value={heroBadge}
                onChange={(v) => onChange({ heroBadge: v })}
        ...
        <div className="px-6 -mt-24 relative z-10 flex flex-col items-center pb-12">
          <div className="mb-8 w-64 h-64">
            {renderImageWindow(
              "w-full h-full shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-[6px] rounded-[16px]",
              { borderColor: boxColor },
            )}
          </div>

          <div
            className={cn(textCardClass, "max-w-[95%]")}
            style={textCardStyle}
          >
            ...
            {renderTestimonials(
              "p-6 rounded-2xl shadow-md my-8 border border-b-4",
            ...
            {hasOffer && (
              <div
                className="p-6 rounded-2xl text-center font-bold text-xl my-8 shadow-sm border"
                style={{
                  color: themeColor,
                  backgroundColor: `${themeColor}10`,
                  borderColor: `${themeColor}33`,
            ...
            {cta && (
              <div className="mt-8 text-center">
                <button
                  className="px-10 py-4 rounded-full font-bold text-[15px] text-white shadow-xl hover:scale-105 active:scale-95 transition-transform"
                  style={{
    ...
    emailContent = (
      ...
      >
        <div
          className="px-8 py-8 flex justify-center border-b"
          style={{
        ...
        <div
          className="p-10 text-left flex-1"
          style={{ backgroundColor: boxColor + "E6", color: textColor }}
        >
          {heroBadge && (
            <div
              className="inline-block px-3 py-1 mb-5 text-[10px] font-bold uppercase tracking-widest border rounded-md"
          ...
          <Editable
            ...
            value={title}
            onChange={(v) => onChange({ subtitle: v })}
            className="font-extrabold tracking-tight text-[36px] mb-6 leading-[1.1]"
            style={{ color: textColor }}
          />
          ...
          {renderTestimonials(
            "border-l-[4px] pl-5 py-2 my-8 rounded-r-xl",
            "font-bold text-[15px]",
            "text-[14px] italic mt-1",
          )}
          ...
          {hasOffer && (
            <div
              className="font-bold text-lg mb-8 py-5 px-6 rounded-xl border text-center shadow-sm"
              style={{
                color: themeColor,
                backgroundColor: `${themeColor}10`,
                borderColor: `${themeColor}33`,
          ...
          {cta && (
            <button
              className="px-8 py-4 rounded-full font-bold text-sm text-white shadow-lg hover:scale-105 transition-transform w-auto active:scale-95"
              style={{
                backgroundColor: themeColor,
    ...
    emailContent = (
      <div
        className={cn(
          "flex flex-col text-center pointer-events-auto w-full h-full",
          fontClass,
        )}
        style={{ color: textColor }}
      >
        ...
        <div
          className="relative shadow-2xl transition-colors duration-500 rounded-t-[40px] border-t-4 z-10 -mt-10"
          style={{ backgroundColor: `${themeColor}E6`, borderColor: boxColor }}
        >
          <div className="p-12 pb-8">
            <Editable
              ...
              value={brandName}
              onChange={(v) => onChange({ brandName: v })}
              className="font-bold tracking-widest text-sm mb-5 uppercase"
              style={{ color: boxColor, opacity: 0.8 }}
            />
            {heroBadge && (
              <div
                className="inline-block px-4 py-1.5 rounded-full mb-5 text-[10px] font-bold uppercase tracking-widest"
                style={{ backgroundColor: `${boxColor}20`, color: boxColor }}
              >
                <Editable
                  as="span"
                  value={heroBadge}
            ...
            <Editable
              ...
              value={title}
              onChange={(v) => onChange({ subtitle: v })}
              className="font-black text-[38px] mb-4 leading-tight"
              style={{ color: boxColor }}
            />
          </div>
        </div>
        ...
        <div
          className="flex-1 p-10 flex flex-col items-center"
          style={{ backgroundColor: boxColor + "E6" }}
        >
          ...
          {hasOffer && (
            <div
              className="font-bold text-lg mb-8 py-5 px-6 rounded-xl border text-center shadow-sm w-full mt-6"
              style={{
                color: themeColor,
                backgroundColor: `${themeColor}10`,
                borderColor: `${themeColor}33`,
          ...
          {renderTestimonials(
            "p-4 bg-black/5 rounded-lg my-6 w-full text-left",
            "font-bold text-[14px]",
            "text-[13px] italic mt-1",
          )}

          {cta && (
            <button
              className="mt-8 px-12 py-4 rounded-xl font-bold text-sm text-white shadow-xl hover:scale-105 active:scale-95 transition-transform"
              style={{ backgroundColor: themeColor }}
            >
              <Editable
                as="span"
          ...
          {footerInfo && (
            <Editable
              ...
              value={footerInfo}
              onChange={(v) => onChange({ footerInfo: v })}
              className="mt-10 text-[11px] opacity-40 uppercase tracking-widest"
              style={{ color: textColor }}
            />
          )}
        </div>
    ...
    emailContent = (
      <div
        className={cn(
          "flex flex-col items-center text-center p-12 pointer-events-auto h-full",
          fontClass,
        )}
        style={{ backgroundColor: `${boxColor}F2` }}
      >
        <Editable
          as="h1"
          value={brandName}
          onChange={(v) => onChange({ brandName: v })}
          className="font-black tracking-[0.2em] text-sm uppercase mb-10 opacity-70"
          style={{ color: textColor }}
        />

        {heroBadge && (
          <div
            className="inline-block px-4 py-1.5 rounded-full mb-6 text-[10px] font-bold uppercase tracking-widest"
        ...
        <Editable
          ...
          value={title}
          onChange={(v) => onChange({ subtitle: v })}
          className="font-extrabold text-[42px] leading-tight mb-8 drop-shadow-sm max-w-[95%]"
          style={{ color: textColor }}
        />

        <div className="w-full aspect-video mb-10">
          {renderImageWindow(
            "w-full h-full rounded-[24px] shadow-2xl border border-white/10",
          )}
        </div>
        ...
        {renderTestimonials(
          "p-6 border border-b-4 rounded-xl shadow-sm my-10 w-full text-left",
          "font-bold text-[15px] mb-1.5",
          "text-[14px] italic",
        )}
        ...
        {hasOffer && (
          <div
            className="w-full font-bold text-xl py-6 px-6 rounded-2xl border text-center shadow-sm my-6"
            style={{
              color: themeColor,
              backgroundColor: `${themeColor}10`,
              borderColor: `${themeColor}33`,
        ...
        {cta && (
          <button
            className="mt-8 px-12 py-5 rounded-2xl font-bold text-sm text-white shadow-xl hover:scale-105 active:scale-95 transition-all w-full max-w-sm"
            style={{
              backgroundColor: themeColor,
              boxShadow: `0 20px 40px -10px ${themeColor}80`,
            }}
          >
            <Editable
              as="span"
        ...
        {footerInfo && (
          <Editable
            ...
            value={footerInfo}
            onChange={(v) => onChange({ footerInfo: v })}
            className="mt-12 text-xs opacity-50 uppercase tracking-widest"
            style={{ color: textColor }}
          />
        )}
      </div>
          ...
          <div className="min-w-0 flex-1 truncate text-[10px] font-semibold uppercase tracking-[0.16em] text-fg-muted flex items-center gap-2">
            ...
            {analyzingColors && (
              <span className="text-xs text-brand animate-pulse flex items-center gap-1">
                <Sparkles className="size-3" /> Cores...
              </span>
            )}
          </div>
          <div className="editor-toolbar-actions shrink-0">
            <Popover>
              ...
              <PopoverContent
                side="top"
                align="end"
                className="mb-2 w-[min(340px,calc(100vw-24px))] rounded-2xl border-border-strong bg-surface-1 p-4 shadow-[var(--shadow-elevated)] z-50"
              >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <Button
                        size="sm"
                        variant={
                          layoutStyle === "minimalist" ? "default" : "outline"
                        }
                        onClick={() => onChange({ layoutStyle: "minimalist" })}
                        className="h-7 text-[11px]"
                      >
                        Clean
                      </Button>
                      ...
                      <Button
                        size="sm"
                        variant={
                          layoutStyle === "editorial" ? "default" : "outline"
                        }
                        onClick={() => onChange({ layoutStyle: "editorial" })}
                        className="h-7 text-[11px]"
                      >
                        Revista
                      </Button>
                      <Button
                        size="sm"
                        variant={
                          layoutStyle === "newsletter" ? "default" : "outline"
                        }
                        onClick={() => onChange({ layoutStyle: "newsletter" })}
                        className="h-7 text-[11px]"
                      >
                        News
                      </Button>
                      <Button
                        size="sm"
                        variant={
                          layoutStyle === "modern" ? "default" : "outline"
                        }
                        onClick={() => onChange({ layoutStyle: "modern" })}
                        className="h-7 text-[11px]"
                      >
                        Moderno
                      </Button>
                      <Button
                        size="sm"
                        variant={
                          layoutStyle === "overlap" ? "default" : "outline"
                        }
                        onClick={() => onChange({ layoutStyle: "overlap" })}
                        className="h-7 text-[11px]"
                      >
                        Overlap
                      </Button>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <Button
                        size="sm"
                        variant={
                          backgroundShape === "square" ? "default" : "outline"
                        }
                        onClick={() => onChange({ backgroundShape: "square" })}
                        className="h-7 text-[11px]"
                      >
                        Quadrado
                      </Button>
                      ...
                      <Button
                        ...
                        onClick={() => onChange({ backgroundShape: "arch" })}
                        className="h-7 text-[11px]"
                      >
                        Arco
                      </Button>
                      <Button
                        ...
                        onClick={() => onChange({ backgroundShape: "pill" })}
                        className="h-7 text-[11px]"
                      >
                        Pílula
                      </Button>
                      <Button
                        ...
                        onClick={() => onChange({ backgroundShape: "blob" })}
                        className="h-7 text-[11px]"
                      >
                        Orgânico
                      </Button>
