...
export function BannerPreview({ state: propState, onChange, exportWrapperClass, exportWrapperStyle }: Props) {
  ...
  if (isCurve) {
     shapeClass = isReverse
      ...
      shapeClass = isReverse
        ? "[clip-path:polygon(0_0,55%_0,55%_100%,0_100%)]"
        : "[clip-path:polygon(45%_0,100%_0,100%_100%,45%_100%)]";
  }
  ...
  return (
    <div className="mx-auto flex w-full flex-col space-y-4" data-testid="banner-preview">
      <div 
         ...
         className={cn(
            "relative overflow-hidden shadow-[0_24px_50px_-12px_rgba(0,0,0,0.6)] flex rounded-[24px] transition-colors duration-500 bg-black",
            exportWrapperClass || "aspect-[2/1] min-h-[380px] w-full",
      ...
      >
         ...
         {/* CORREÇÃO: Readicionada a regra de pointer-events-auto */}
         <div className="absolute inset-0 z-30 pointer-events-none [&>*]:pointer-events-auto" style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 30 }}>
             {draggableImages.length > 0 && draggableImages.map((src, i) => (
                <DraggableImage key={`banner-img-${i}`} src={src} type="banner" />
             ))}
         </div>

         <div className="relative z-10 w-full h-full flex">
            {isCentered ? (
               <div className="relative w-full h-full flex flex-col items-center justify-center p-12 text-center [.force-mobile_&]:!p-8 z-10 pointer-events-none">
                  ...
                  <div className={cn(
                     ...
                     {!safeBgUrl && draggableImages.length === 0 && (
                  ...
                  <div className="relative z-40 w-full h-full flex flex-col items-center justify-center pointer-events-none">
                     <DraggableBlock id="banner-title-center" className="pointer-events-auto w-full max-w-2xl flex flex-col items-center">
                       <div 
                         className={cn(
                       ...
                       >
                           <Editable as="h2" value={title} onChange={(v)=>onChange({title:v})} className="font-extrabold text-[42px] [.force-mobile_&]:!text-[28px] leading-[1.1] tracking-tighter break-words text-balance" style={{ color: textColor }} />
                           
                           {hasSubtitle && <Editable as="p" multiline value={subtitle} onChange={(v)=>onChange({subtitle:v})} className={cn("font-medium opacity-90 text-[18px] [.force-mobile_&]:!text-[15px] leading-relaxed max-w-[90%] mx-auto mt-4 break-words pointer-events-auto", !isComplexShape && "drop-shadow-sm")} style={{ color: textColor }} />}
                           
                           {bodyText && <Editable as="p" multiline value={bodyText} onChange={(v)=>onChange({body:v})} className={cn("font-normal opacity-70 text-[15px] [.force-mobile_&]:!text-[13px] leading-relaxed max-w-[90%] mx-auto mt-3 break-words pointer-events-auto block [.force-mobile_&]:!hidden", !isComplexShape && "drop-shadow-sm")} style={{ color: textColor }} />}
                           
                           {benefits.length > 0 && (
                              <div className="flex flex-wrap justify-center gap-2 mt-6">
                                 {benefits.map((ben, i) => (
                                    <span key={i} className="border border-white/10 text-[11px] [.force-mobile_&]:!text-[10px] uppercase tracking-widest font-bold px-4 py-2 rounded-xl shadow-inner" style={{ color: textColor, backgroundColor: `${boxColor}40` }}>{ben}</span>
                                 ))}
                              </div>
                           )}
                       </div>
                     ...
                     {footerInfo && (
                        <div className="mt-auto pt-6 pointer-events-auto">
                           <Editable as="p" value={footerInfo} onChange={(v)=>onChange({footerInfo:v})} className="font-medium opacity-60 text-[12px] [.force-mobile_&]:!text-[10px] uppercase tracking-widest break-words" style={{ color: textColor }} />
                        </div>
                     )}

                     {(badgePrimary || badgeSecondary) && (
                        <DraggableBlock id="banner-badge-center" className="absolute z-50 bottom-8 right-8 flex flex-col items-end gap-3 pointer-events-auto [.force-mobile_&]:!bottom-4 [.force-mobile_&]:!right-4">
                           {badgePrimary && (
                              <div className="rounded-full size-[140px] [.force-mobile_&]:!size-[100px] flex items-center justify-center text-center p-3 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] border border-white/20" style={{ backgroundColor: `${boxColor}F2`, color: textColor }}>
                                 <Editable as="span" value={badgePrimary} onChange={(v)=>onChange({badgePrimary:v})} className="font-black text-4xl [.force-mobile_&]:!text-2xl leading-[1.0] tracking-tighter" style={{ color: textColor }} />
                              </div>
                           )}
                           {badgeSecondary && (
                              <div className="rounded-full px-5 py-2.5 text-center shadow-lg border border-white/20 relative z-10" style={{ backgroundColor: themeColor, color: textColor }}>
                                 <Editable as="span" value={badgeSecondary} onChange={(v)=>onChange({badgeSecondary:v})} className="font-bold text-sm [.force-mobile_&]:!text-[12px] tracking-wide leading-tight" style={{ color: textColor }} />
                              </div>
                           )}
                        </DraggableBlock>
                     )}
               ...
               <div className={cn("relative w-full h-full flex overflow-hidden z-10 flex-row [.force-mobile_&]:!flex-col")} style={{ backgroundColor: 'transparent' }}>
                  ...
                  <div className={cn(
                     ...
                     isOffset ? "m-8 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.6)] overflow-hidden scale-95 border border-white/10 [.force-mobile_&]:!m-0" :
                     "overflow-hidden",
                  ...
                  {!isComplexShape && (
                    <>
                      <div className={cn(
                         ...
                         shapeClass,
                         "[.force-mobile_&]:!inset-auto [.force-mobile_&]:!bottom-0 [.force-mobile_&]:!left-0 [.force-mobile_&]:!w-full [.force-mobile_&]:!h-[55%] [.force-mobile_&]:!border-t [.force-mobile_&]:!border-r-0 [.force-mobile_&]:!border-l-0"
                  ...
                  <div className={cn(
                     ...
                     isReverse ? "pr-14 pl-4 items-end text-right [.force-mobile_&]:!pr-8" : "pl-14 pr-4 items-start text-left [.force-mobile_&]:!pl-8",
                     isComplexShape ? (isReverse ? "pr-16 [.force-mobile_&]:!pr-10" : "pl-16 [.force-mobile_&]:!pl-10") : "",
                     ...
                     <DraggableBlock id="banner-text-split" className={cn(
                        ...
                        >
                            <Editable as="h2" value={title} onChange={(v)=>onChange({title:v})} className={cn("font-extrabold text-[46px] [.force-mobile_&]:!text-[28px] leading-[1.05] tracking-tighter break-words text-balance", !isOffset && "drop-shadow-lg")} style={{ color: textColor }} />
                            
                            {!isComplexShape && (
                              <div className={cn("absolute top-6 opacity-30", isReverse ? "left-6" : "right-6", "[.force-mobile_&]:!hidden")}>
                                 <ArrowUpRight className="size-10" style={{ color: textColor }} strokeWidth={2} />
                              </div>
                            )}
                        </div>
                        
                        {hasSubtitle && <Editable as="p" multiline value={subtitle} onChange={(v)=>onChange({subtitle:v})} className={cn("font-semibold opacity-95 text-[18px] [.force-mobile_&]:!text-[14px] leading-relaxed max-w-[95%] break-words mb-3", (!isComplexShape || isOffset) && "drop-shadow-md")} style={{ color: textColor }} />}
                        {bodyText && <Editable as="p" multiline value={bodyText} onChange={(v)=>onChange({body:v})} className={cn("font-normal opacity-80 text-[14px] [.force-mobile_&]:!text-[12px] leading-relaxed max-w-[95%] break-words mb-5 block [.force-mobile_&]:!hidden", (!isComplexShape || isOffset) && "drop-shadow-md")} style={{ color: textColor }} />}
                        
                        {benefits.length > 0 && (
                           <div className={cn("flex flex-wrap gap-2 mt-4", isReverse ? "justify-end" : "justify-start", "[.force-mobile_&]:!justify-center")}>
                              {benefits.map((ben, i) => (
                                 <span key={i} className="border border-white/10 text-[12px] [.force-mobile_&]:!text-[10px] uppercase tracking-widest font-bold px-4 py-2 rounded-xl shadow-inner" style={{ color: isComplexShape ? boxColor : textColor, backgroundColor: isComplexShape ? themeColor : `${boxColor}40` }}>{ben}</span>
                              ))}
                           </div>
                        )}
                     </DraggableBlock>
                     ...
                     {footerInfo && (
                        <div className="mt-auto pt-8 pointer-events-auto block [.force-mobile_&]:!hidden">
                           <Editable as="p" value={footerInfo} onChange={(v)=>onChange({footerInfo:v})} className="font-medium opacity-60 text-[12px] uppercase tracking-widest break-words drop-shadow-sm" style={{ color: textColor }} />
                        </div>
                     )}
                  </div>

                  {(badgePrimary || badgeSecondary) && (
                     <DraggableBlock id="banner-badge-split" className={cn(
                        ...
                        {badgePrimary && (
                           <div className="rounded-full size-[140px] [.force-mobile_&]:!size-[100px] flex items-center justify-center text-center p-3 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] border border-white/20" style={{ backgroundColor: `${boxColor}F2`, color: textColor }}>
                              <Editable as="span" value={badgePrimary} onChange={(v)=>onChange({badgePrimary:v})} className="font-black text-[36px] [.force-mobile_&]:!text-[24px] leading-[1.0] tracking-tighter" style={{ color: textColor }} />
                           </div>
                        )}
                        {badgeSecondary && (
                           <div className="rounded-full px-5 py-2.5 text-center shadow-lg border border-white/20 relative z-10" style={{ backgroundColor: themeColor, color: textColor }}>
