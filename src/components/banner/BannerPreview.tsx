...
export default function BannerPreview({
  ...
  return (
    <div
      ...
      className={[containerClass, exportWrapperClass ?? ""]
        .filter(Boolean)
        .join(" ")}
      style={{
        ...containerStyle,
      ...
      >
        ...
        {content.subheading && (
          <p
            ...
            style={{ color: content.textColor, opacity: 0.85 }}
          >
            {content.subheading}
          </p>
        )}
        {content.ctaText && (
          <span
            ...
            style={{
              ...
              padding: exportMode
                ? "12px 32px"
                : "8px 20px md:10px 28px max-md:6px 16px",
  ...
  return (
    ...
    >
      ...
      {shape === "diagonal" && (
        <svg {...svgProps} style={{ position: "absolute", top: 0, left: 0 }}>
          <polygon
            points="1200,0 1200,600 700,600 900,0"
            fill={accentColor}
            opacity={0.15}
          />
        </svg>
