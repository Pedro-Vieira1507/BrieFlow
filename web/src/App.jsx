...
import {
  Send, Upload, ImagePlus, FileText, Download,
  ChevronDown, Sparkles, X, CheckCircle, AlertCircle,
  Paperclip, Zap
} from 'lucide-react'
      ...
      <div className="flex flex-col flex-1 min-w-0 h-full">
        ...
        <div className="px-4 pb-2 flex gap-2 overflow-x-auto scrollbar-hide">
          {MATERIAL_CHIPS.map(chip => (
            <button
              key={chip.label}
              onClick={() => sendMessage(chip.prompt + (contexto ? '' : ' — adicione o contexto na lateral'))}
